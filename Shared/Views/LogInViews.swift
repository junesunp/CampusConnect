...
struct LogInViews: View {
    ...
    //@State var asStudent = sviewModel.isStudent
    var body: some View {
            NavigationView {
                VStack {
                    VStack {
            ...
            //VStack {
                VStack {
                    ...
                    TextField("major", text: $major)
                        ...
                        .background(Color(.secondarySystemBackground))
                    Button(action: {
                        stuViewModel.createStudent(id: auth.currentUser!.uid, email: email, password: password, username: username, fname: fname, lname: lname, schoolName: schoolName, major: major, gradYear: gradYear[selectedYearIndex])
            ...
            //VStack {
                VStack {
                    ...
                    TextField("Position/Role", text: $position)
                        ...
                        .background(Color(.secondarySystemBackground))
                    Button(action: {
                        recViewModel.createRecruiter(email: email, password: password, username: username, fname: fname, lname: lname, company: company, role: position)
                        recViewModel.fetchRecruiter(email: email)
                        sviewModel.signUp(email: email, password: password)
